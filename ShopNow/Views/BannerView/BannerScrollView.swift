...
@objc protocol BannerScrollViewDelegate: NSObjectProtocol {
    ...
    @objc optional func infiniteScrollView(_ infiniteScrollView: BannerScrollView, didSelectedItemAt indexPath: IndexPath)
    @objc optional func infiniteScrollView(_ infiniteScrollView: BannerScrollView, didScrollToItemAt indexPath: IndexPath)
}

class BannerScrollView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private(set) lazy var pageControl: BannerPageControl = {
...
extension BannerScrollView.CellType {
...
extension BannerScrollView.ScrollPosition {
